...
if uploaded_file is not None:
    ...
    lag1 = col1.number_input("Lag1 (Stunting Tahun Terakhir (%))", 0.0, 100.0, 15.0)
    lag2 = col2.number_input("Lag2 (2 Tahun Lalu (%))", 0.0, 100.0, 16.0)
    lag3 = col3.number_input("Lag3 (3 Tahun Lalu (%))", 0.0, 100.0, 17.0)
